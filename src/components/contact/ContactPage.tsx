...
export function ContactPage({ sales, quality, commitment }: { sales: ReactNode; quality: ReactNode; commitment: ReactNode }) {
  ...
  return <div className="contact-page">
    ...
    <div className="contact-surface">
      ...
      <div className="product-center-container">
        <div className="contact-tabs" role="tablist" aria-label="联系我们栏目">
          {tabs.map(({ id, label, icon: Icon }, index) => <button
            ...
            tabIndex={active === id ? 0 : -1} className={active === id ? "is-active" : ""} key={id}
        ...
        <section id="contact-panel-sales" role="tabpanel" aria-labelledby="contact-tab-sales" hidden={active !== "sales"} className="contact-panel">
          {sales}
        </section>
        <section id="contact-panel-after-sales" role="tabpanel" aria-labelledby="contact-tab-after-sales" hidden={active !== "after-sales"} className="contact-panel">
        ...
        <section id="contact-panel-supply-chain" role="tabpanel" aria-labelledby="contact-tab-supply-chain" hidden={active !== "supply-chain"} className="contact-panel">
...
function ContactMailForm({ kind }: { kind: "feedback" | "supplier" }) {
  ...
  return <form className="contact-mail-form" onSubmit={prepareEmail}>
